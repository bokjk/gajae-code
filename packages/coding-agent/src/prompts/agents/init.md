...
Generate AGENTS.md by scanning different areas (core src, tests, configs/build, scripts/docs) with `read`, `search`, and `find`, then synthesize findings into a single file.
