...
<procedure>
### Phase 1: Understand
You MUST focus on the request and associated code. You SHOULD investigate multiple areas in parallel with read-only `read`/`search`/`find` passes when scope spans multiple areas.
